...
## CHEMISTRY MODEL AND CHEMICAL REACTION LIST
  ...
  *Note* : SBS is supposed for totally diffusion-controlled (TDC) reaction only, then please set reaction type 0 if use of this model. Only G4EmDNAChemistry_option3 can change the time step model
